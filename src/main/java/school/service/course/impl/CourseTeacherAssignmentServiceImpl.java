...
public class CourseTeacherAssignmentServiceImpl implements CourseTeacherAssignmentService {
  //  Method to add a teacher
  @Override
  public void addTeacher(Department department, Scanner scanner) {
  ...
  @Override
  public void assignTeacherToCourse(Department department, Scanner scanner, SchoolClass defaultClass) {
